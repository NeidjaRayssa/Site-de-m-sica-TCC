...
const main = document.getElementById('conteiner-Princpal')
...
const morteDoVaqueiro = {
    songName : 'A Morte Do Vaqueiro',
    artist : 'Luiz Gonzaga',
    file : 'A_Morte_Do_Vaqueiro',
    liked : false
};
...
const conde1 = {
    songName : 'Espelho Do Poder',
    artist : 'Conde Só Brega',
    file : 'Espelho_do_poder',
    liked : false
};

const conde2 = {
    songName : 'Pensando Só Em Você',
    artist : 'Conde Só Brega',
    file : 'pensando_so_em_vc',
    liked : false
};

const conde3 = {
    songName : 'Procure Entender',
    artist : 'Conde Só Brega',
    file : 'Procure_entender',
    liked : false
};


const BartoGalenô = {
    songName : 'Saudade De Rosa',
    artist : 'Barto Galenô',
    file : 'Saudade_de_Rosa',
    liked : false
};
...
const alceu = {
 ...
 const originplaylist = JSON.parse(localStorage.getItem('playlist'))?? [morteDoVaqueiro,luizGonzaga,Apraieira,alceu2,conde1,conde2,conde3,BartoGalenô,luizGonzaga1,alceu];
 ...
 function looadsong(){
    ...
    main.style.backgroundImage =`url(bg/${sortedPlalist[index].file}.jpg)`;
    likeButtomRender();
